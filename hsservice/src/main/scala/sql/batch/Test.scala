...
//    .config.properties("spark.sql.warehouse.dir", warehouseLocation)
//    .config.properties("hive.exec.dynamic.partition", "true")
//    .config.properties("hive.exec.dynamic.partition.mode", "nonstrict")
//    .config.properties("hive.exec.max.dynamic.partitions", 2000)
//    .config.properties("spark.serializer", "org.apache.spark.serializer.KryoSerializer")
//    .config.properties("spark.kryoserializer.buffer", "1024m")
//    .config.properties("spark.kryoserializer.buffer.max", "2046m")
//    .config.properties("spark.io.compression.codec", "snappy")
//    .config.properties("spark.sql.codegen", "true")
//    .config.properties("spark.sql.unsafe.enabled", "true")
//    .config.properties("spark.shuffle.manager", "tungsten-sort")
//    .enableHiveSupport()
//    .getOrCreate()
//}
