...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        // 参数二：循环遍历次数
        int loopLen = args.length > 1 ? Integer.parseInt(args[1]) : 1000;
    ...
    private static void generateLog(Long delay, int loopLen) {
    ...
    private static JSONObject generateNewsDetail() {
        ...
        // 动作
        appNewsDetail.setAction("" + (random.nextInt(4) + 1));
    ...
    private static AppStart generateStart() {
        ...
        switch (flag) {
            case 0:
                ...
                appStart.setMd("sumsung-" + random.nextInt(20));
                break;
            case 1:
            ...
            case 2:
                appStart.setBa("HTC");
                appStart.setMd("HTC-" + random.nextInt(20));
                break;
        }
    ...
    private static JSONObject generatbeforeground() {
        ...
        AppActiveForeground appActiveForeground = new AppActiveForeground();

        // 推送消息的id
        int flag = random.nextInt(2);
        switch (flag) {
            case 1:
                appActiveForeground.setAccess(flag + "");
                break;
            default:
                appActiveForeground.setAccess("");
                break;
        }

        // 1.push 2.icon 3.其他
        flag = random.nextInt(3) + 1;
        appActiveForeground.setPushId(flag + "");

        JSONObject jsonObject = (JSONObject) JSON.toJSON(appActiveForeground);
